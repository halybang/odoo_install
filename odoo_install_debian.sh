...
OE_HOME_EXT="$OE_BASE/${OE_USER}-server"

OE_ADDONS_PATH="$OE_HOME_EXT/addons,$OE_BASE/custom/addons"
...
if [ $IS_ENTERPRISE = "True" ]; then
	...
	echo -e "\n---- Adding Enterprise code under $OE_BASE/enterprise/addons ----"

	git clone --depth 1 --branch $OE_VERSION https://www.github.com/odoo/enterprise "$OE_BASE/enterprise/addons"
	...
	OE_ADDONS_PATH="$OE_BASE/enterprise/addons,$OE_ADDONS_PATH"
...
data_dir = /var/lib/$OE_USER/.local/share/Odoo$OE_VERSION
