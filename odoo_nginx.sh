...
##
# This script creates self-signed certificate and config file for nginx
# Nginx was used as a reverse proxy for Odoo
# 
# For examples:
#   subdomain1.erphanoi.com -> using Odoo database1.
#   subdomain2.erphanoi.com -> using Odoo database2.
#   If missing database name, using the database with same name as subdomain, depend on dbfilter parma of Odoo config.
##
...
DOMAIN="$1.erphanoi.com" # Change to your domain
DB=$2
